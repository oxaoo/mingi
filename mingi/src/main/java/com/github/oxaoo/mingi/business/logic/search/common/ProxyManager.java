package com.github.oxaoo.mingi.business.logic.search.common;
...
import static com.github.oxaoo.mingi.business.logic.common.PropertyKeeper.PROXY_HOST_KEY;
import static com.github.oxaoo.mingi.business.logic.common.PropertyKeeper.PROXY_PORT_KEY;
...
public class ProxyManager {
    ...
    public static Proxy getProxyIf() {
        ...
        if (isExistProxy) {
            String proxyHost = PropertyKeeper.get(PROXY_HOST_KEY);
            String proxyPortStr = PropertyKeeper.get(PROXY_PORT_KEY);
