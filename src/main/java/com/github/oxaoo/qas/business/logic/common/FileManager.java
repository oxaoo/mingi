...
import com.github.oxaoo.qas.data.source.FileReader;
import com.github.oxaoo.qas.data.source.FileWriter;
...
public class FileManager {
    ...
    public boolean saveFile(InputStream uploadedInputStream, FormDataContentDisposition fileDetail) {
        return this.fileWriter.stream2File(uploadedInputStream, fileDetail);
    }
